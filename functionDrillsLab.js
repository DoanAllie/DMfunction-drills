...
const nameGreeting = nameCheck("Miso");
...
// console.log(emailCheck("misoshibainu@gmail.com"));
...
//CODE HERE
const buyChocolateFrogs = num =>  num / 3;
const totalFrogs = buyChocolateFrogs(4);
...
const buyChocolateFrogs2 = num => Math.floor(num / 3);
const totalFrogs2 = buyChocolateFrogs2(4);
...
let bathtubScope = ["duck", "rubberDuck", "nautical"]
